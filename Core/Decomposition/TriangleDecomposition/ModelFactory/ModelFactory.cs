using TriangleScpSl.Core.Decomposition.TriangleDecomposition.FileToTriangles;
using TriangleScpSl.Core.Paths;
using TriangleScpSl.Core.Primitives.Triangle;
using UnityEngine;

namespace TriangleScpSl.Core.Decomposition.TriangleDecomposition.ModelFactory;

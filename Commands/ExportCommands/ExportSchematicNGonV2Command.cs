...
public sealed class ExportSchematicNGonV2Command : ICommand
{
    ...
    public string Description { get; } = "Exports an OBJ as ProjectMER schematic JSON using ApproximateModel. Usage: <model file (.obj)> <output JSON file>";
    ...
    public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
    {
        ...
        {
            response = "Usage: ExportSchematicNGonV2 <model file (.obj)> <output JSON file>";
            return false;
        }

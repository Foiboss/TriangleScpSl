...
public sealed class ExportSchematicNGonV3Command : ICommand
{
    ...
    public string Description { get; } = "Exports an OBJ as ProjectMER schematic JSON using V3 hierarchical model. Usage: <model file (.obj)> <output JSON file>";
    ...
    public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
    {
        ...
        {
            response = "Usage: ExportSchematicNGonV3 <model file (.obj)> <output JSON file>";
            return false;
        }
